...
{
    /// <summary>
    /// Interaction logic for Katakana.xaml
    /// </summary>
    public partial class Katakana : Window
    {
        ...
        {
            InitializeComponent();
            DataContext = new KatakanaViewModel();
            ...
            Binding itemsSourceBinding = new Binding("KatakanaPairs");
            ...
            {
                if (
                    DataContext is KatakanaViewModel viewModel
